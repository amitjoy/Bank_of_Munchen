                                                ...
                                                <div class="panel-body">
                                                    <form role="form" action="banklogin.php" method="POST" id="loginForm" onsubmit="return validation()">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <object type="application/x-shockwave-flash" data="./../libs/securimage/securimage_play.swf?bgcol=%23ffffff&amp;icon_file=%2Fsecurimage%2Fimages%2Faudio_icon.png&amp;audio_file=%2Fsecurimage%2Fsecurimage_play.php" height="32" width="32"><param name="movie" value="/securimage/securimage_play.swf?bgcol=%23ffffff&amp;icon_file=%2Fsecurimage%2Fimages%2Faudio_icon.png&amp;audio_file=%2Fsecurimage%2Fsecurimage_play.php"></object>
                                                            <a href="#" onclick="document.getElementById('captcha').src = './../libs/securimage/securimage_show.php?' + Math.random(); return false"><img height="32" width="32" src="/securimage/images/refresh.png" alt="Refresh Image" onclick="this.blur()" border="0"></a>
                                                        </div>
                                                        <div class="form-group">
