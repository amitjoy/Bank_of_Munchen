...
try {
    ...
    $userArray = $db->select("USERS", "isActive = 1 and isAdmin= 0");
        ...
        <div id="menu" class="hidden-print hidden-xs  sidebar-white">
            <div id="sidebar-collapse-wrapper">
                ...
                <ul class="menu list-unstyled" id="navigation_current_page">
                    ...
                    <?php if ($row->isAdmin == 1) { ?>
					<li class="active"><a href="#" class="glyphicons parents"><i></i><span>Privilege Change</span></a>
                        <?php } ?>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="box-generic">
						...
						<div class="widget ">
                            <div class="widget-head">
                                <h4 class="heading"><i class="fa fa-fw fa-user text-primary"></i> Users List without Administrative Privilege</h4>
                            </div>
